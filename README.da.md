...
- 💠 **[PRISME: spektral lagring og optical-routing-simulator](https://github.com/Janus5G/PRISME)**
- 🌈 **[Prøv PRISME-glaspladedemoen](https://Janus5G.github.io/PRISME/demo/prisme.html)**
...
## Forbindelsen til PRISME

[PRISME](https://github.com/Janus5G/PRISME) er det tilknyttede projekt for det
spektrale og optiske lag. Det undersøger bytekodning over rød, grøn, blå,
violet og UV, UV-fejlkontrol, optical routing og en browserbaseret
visualisering af glaspladeregisteret.
...
CPL-kildekode
   ↓
ChromaPlex-compiler og CPA-instruktionssæt
   ↓
ChromaPlex-krystalsimulator
   ↓
PRISME spektral kodning og optical-routing-model
```

- [Åbn PRISME-repositoryet](https://github.com/Janus5G/PRISME)
- [Prøv den levende PRISME-glaspladedemo](https://Janus5G.github.io/PRISME/demo/prisme.html)
...
├── demo/                    # Statisk browserdemo
├── index.html               # Startside til GitHub Pages
├── README.md                # Engelsk standard-README
├── README.da.md             # Dansk README
├── setup.py
└── LICENSE
```
...
- [ChromaPlex 3D-krystalsimulator](https://Janus5G.github.io/chromaplex-os/)
- [PRISME levende glaspladeregister](https://Janus5G.github.io/PRISME/demo/prisme.html)

ChromaPlex-demoen publiceres automatisk gennem GitHub Pages, når
`index.html`, `demo/` eller Pages-workflowet ændres.
...
- [PRISME: spektral lagring og optical-routing-model](https://github.com/Janus5G/PRISME)
